...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH; df | grep /dev | head -1" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH; df | grep /dev/graphics/fb0 | head -1" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH; df | grep /data | head -1" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH; df | grep / | head -1" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH; df | grep /sys/fs/cgroup | head -1" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH; df | grep /mnt | head -1" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH; df | grep /subin | head -1" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH; df | grep /storage | head -1" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH; df | grep /mnt/runtime/default/emulated | head -1" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH; df | grep /storage/emulated | head -1" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH; df | grep /mnt/runtime/read/emulated | head -1" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH; df | grep /mnt/runtime/write/emulated | head -1" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH; df | grep /data/nfs | head -1" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH; dumpsys battery" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH;echo -n "attribute:";cat /sys/devices/system/cpu/cpu0/cpufreq/cpuinfo_cur_freq" >> ${OUT_FILE_NAME}
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH;echo -n "temperatue:";cat /sys/class/thermal/thermal_zone0/temp" >> ${OUT_FILE_NAME}
...
ssh $HOSTCHECK $IP "export BOOTCLASSPATH=$BOOTCLASSPATH;top -bn1" >> ${OUT_FILE_NAME}
